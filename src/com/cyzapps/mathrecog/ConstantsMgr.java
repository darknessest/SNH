...
public class ConstantsMgr {
    ...
    */
    ...
    public static double msdAbnormalVCutGapThresh = 0.8;  // if v-cut gap is larger than 0.5 * average char width + gap, means it is end of expression
    ...
    public static double msdRoundBracketTo1WOverHThresh = 0.2;  // for misrecognized ( or ), if w/h <= 0.35, it is likely to be 1.
